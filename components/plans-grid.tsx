  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md hover:bg-muted/10 relative group">
      <CardHeader className="pb-3 px-6 pt-6">
        <CardTitle className="line-clamp-1 font-oswald font-light uppercase tracking-wide">{plan.name}</CardTitle>
        <CardDescription className="flex items-center gap-2">
          Created {createdAgo}
          {isRecentlyUpdated && (
            <Badge variant="secondary" className="ml-2">Recently Updated</Badge>
          )}
        </CardDescription>
      </CardHeader>
      <CardContent className="pb-0 px-6">
        <p className="text-sm text-muted-foreground">
          Last viewed {updatedAgo}
        </p>
      </CardContent>
