    ...
    <Dialog open={isInfoDialogOpen} onOpenChange={(open) => !open && closeInfoDialog()}>
      <DialogContent className="max-w-dialog-lg dialog-content-base">
        <DialogHeader>
          ...
          <DialogDescription>A JSON-based training plan visualization tool</DialogDescription>
        </DialogHeader>
          ...
          <ScrollArea className="h-[400px] mt-4">
            <TabsContent value="about" className="p-1">
              <div className="prose prose-sm dark:prose-invert">
                <p>
                  T-JSON is a web application for visualizing and managing training plans stored in
                  a standardized JSON format. It allows coaches and athletes to create, edit, and
                  track personalized workout plans.
                </p>
                <p>
            ...
            <TabsContent value="features" className="p-1">
              <div className="prose prose-sm dark:prose-invert">
                <ul>
                  <li>
                    Block & Weekly Views - Switch between block overviews and detailed weekly
                    schedules
                  </li>
                  <li>Multiple Training Plans - Create, edit, and manage multiple plans</li>
                  <li>
                    Detailed Exercise Tracking - View complete details for exercises including sets,
                    reps, load
                  </li>
            ...
            <TabsContent value="json" className="p-1">
              <div className="prose prose-sm dark:prose-invert">
                <p>T-JSON uses a normalized JSON structure with three main sections:</p>
                <ul>
                  <li>
                    <strong>exerciseDefinitions</strong> - Definitions of all exercises
                  </li>
                  <li>
                    <strong>weeks</strong> - An array of all training weeks
                  </li>
                  <li>
                    <strong>bocks</strong> - Information about how weeks are grouped
                  </li>
                </ul>
                <p>For complete documentation on the JSON format, visit the documentation page.</p>
